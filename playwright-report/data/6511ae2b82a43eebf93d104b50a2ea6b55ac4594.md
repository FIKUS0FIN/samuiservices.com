  ...
  - main [ref=e15]:
    - generic [ref=e17]:
      - generic [ref=e18]:
        ...
        - paragraph [ref=e20]: Sign in to manage your services and bookings.
      - generic [ref=e22]:
        - button "Continue with Google" [ref=e23] [cursor=pointer]:
          - img [ref=e24]
          - text: Continue with Google
        - generic [ref=e33]: Or (Test Mode)
        - generic [ref=e34]:
          - textbox "Email Address" [ref=e35]
          - textbox "Password" [ref=e36]
          - button "Test Sign In" [ref=e37] [cursor=pointer]
  - contentinfo [ref=e38]:
    - paragraph [ref=e40]: © 2026 Samui Services. All rights reserved.
```
...
```ts
  ...
  12  |   }
  13  |   await page.click('button:has-text("Test Sign In")');
> 14  |   await page.waitForURL('/dashboard');
  ...
  94  |     const firstListing = page.locator('.listing-card-container a').first();
