...
> The premier business directory for Koh Samui, Thailand. Discover restaurants, real estate, transportation, and trusted local services.
...
- **Example:** \`https://samuiservices.com/api/agent/listing/the-coco-club-chaweng\`
- **Note:** All HTML business listing pages contain a \`<link rel="alternate" type="text/markdown">\` tag pointing to this API.

## Sitemaps
- Main XML Sitemap: \`https://samuiservices.com/sitemap.xml\`
